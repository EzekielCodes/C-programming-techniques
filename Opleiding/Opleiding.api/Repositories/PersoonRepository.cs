...
public class PersoonRepository:IPersoonRepository
{
    ...
    public PersoonRepository(SignInManager<Persoon> signInManager, UserManager<Persoon> userManager ,AppSettings appSettings, IHttpContextAccessor httpContextAccessor)
    {
